...
module.exports = function(config) {
  config.set({
    ...
    files: [
      ...
      'src/selectable/selectable_collection.js',
      'src/selectable/selectable_model.js',
      'src/selectable/selectable_factory.js',
//      'src/selectable/**/*.js',
      'src/model/model.js',
      ...
      'src/security/member.js',
      'src/security/members.js',
      'src/security/group.js',
      'src/security/groups.js',
      'src/security/user.js',
      'src/security/users.js',
      'src/security/authenticated_user.js',
